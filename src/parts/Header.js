                ...
                <div className="flex flex-stretch items-center">
                    ...
                    <div className="w-auto">
                        <ul className="items-center flex">
                            ...
                            <li className="ml-6">
                                <Link id="header-cart" className={["cart flex items-center justify-center w-8 h-8", theme === "white" ? " text-black md:text-white" : " text-white md:text-black", state.cart && Object.keys(state.cart).length > 0 ? "cart-filled" : "", isCartChanged ? "animate-bounce" : ""].join(" ")} to="/cart">
                                    <IconCart />
                                </Link>
                            </li>
                        </ul>
