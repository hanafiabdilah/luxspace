            ...
            <div className="container mx-auto py-5">
                <div className="flex flex-stretch items-center">
                    ...
                    <div className="w-auto">
                        <ul className={["fixed bg-white inset-0 flex flex-col items-center justify-center md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center", toggleMainMenu? "opacity-100 z-30 visible": "invisible opacity-0",].join(" ")}>
                    ...
                    <div className="w-auto">
                        <ul className="items-center flex">
                            ...
                            <li className="ml-6">
                                <Link id="header-cart" className={["cart flex items-center justify-center w-8 h-8",theme === "white" ? "text-black md:text-white " : "text-black md:text-black ", state.cart && Object.keys(state.cart).length > 0 ? "cart-filled" : "", isCartChanged ? "animate-bounce" : ""].join(" ")} to="/cart">
                                    <IconCart />
                                </Link>
                            </li>
                        </ul>
