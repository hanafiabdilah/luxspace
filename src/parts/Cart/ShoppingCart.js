        ...
        <div className="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
            ...
            </div>
            {
                ...
                <p id="cart-empty" className="text-center py-8">
                    Ooops... Cart is empty
                    <Link to="/" className="underline ml-2">Shop Now</Link>
                </p>
                :
                Object.keys(state.cart).map( key => {
                    const item = state.cart[key]
                    return (
                        <div key={key} className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
                            <div className="px-4 flex-none">
                            ...
                            <div className="px-4 w-2/12">
                                <div className="text-center">
                                    <button data-delete-item="1" className="text-red-600 border-none focus:outline-none px-3 py-1" onClick={() => dispatch({type: "REMOVE_FROM_CART", id: item.id})}>
                                        X
                                    </button>
                                </div>
                            </div>
